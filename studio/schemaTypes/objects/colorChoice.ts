...
export default defineType({
  ...
  fields: [
    ...
    },
    {
      ...
      name: 'gradientNote',
      type: 'note',
      hidden: ({parent}: {parent: any}) => parent?.colorType !== 'gradient',
      description: 'This only works for background colors. Text will remain default.',
    },
    {
      title: 'Color (Dark)',
      name: 'colorDark',
    ...
    },
    {
      title: 'Color (Custom)',
      description:
        'When choosing custom, it is your responsibility to ensure accessibility contrast standards are met.',
      name: 'colorCustom',
      type: 'color',
      options: {
        disableAlpha: true,
